...
class ViewDonations : Fragment() {
    ...
    private lateinit var listener: ViewDonationsInterface
    ...
    override fun onAttach(context: Context) {
        ...
        if(context is ViewDonationsInterface){
            listener = context
        }
    }
    ...
    override fun onCreateView(
        ...
        val va = inflater.inflate(R.layout.fragment_view_donations, container, false)
    ...
    interface ViewDonationsInterface{
