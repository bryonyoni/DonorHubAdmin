...
class ViewOrganisations : Fragment() {
    ...
    private lateinit var listener: ViewOrganisationsInterface
    ...
    override fun onAttach(context: Context) {
        ...
        if(context is ViewOrganisationsInterface){
            listener = context
        }
    }
    ...
    override fun onCreateView(
        ...
        val va = inflater.inflate(R.layout.fragment_view_organisations, container, false)
    ...
    interface ViewOrganisationsInterface{
